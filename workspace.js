...
cprequire_test(["inline:com-chilipeppr-workspace-tinyg-4th-axis"], function(ws) {
    ...
    $('title').html("TinyG 4th Axis Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-tinyg-4th-axis", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-tinyg-4th-axis", // Make the id the same as the cpdefine id
        name: "Workspace / TinyG 4th Axis", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for working with a TinyG having a 4th (rotational) axis.`,
